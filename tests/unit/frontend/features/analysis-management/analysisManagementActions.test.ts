...
const mockAdminDocGet = jest.fn(); // For checking doc existence
const mockAdminDoc = jest.fn(() => ({ get: mockAdminDocGet }));
const mockAdminFirestore = {
  doc: mockAdminDoc,
};

jest.mock('@/lib/firebase-admin', () => ({
  adminDb: mockAdminFirestore, // Mock adminDb for doc check
  adminPubSub: { topic: mockTopic },
}));
...
describe('Analysis Management Server Actions (Unit)', () => {
  beforeEach(() => {
