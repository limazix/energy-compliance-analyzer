...
const nextConfig: NextConfig = {
  ...
  env: {
    ...
    NEXT_PUBLIC_FIREBASE_MEASUREMENT_ID: "G-4ZE09LKDQM",
    NEXT_PUBLIC_FIREBASE_DATABASE_URL: "https://electric-magnitudes-analizer-default-rtdb.firebaseio.com",
    // Keep existing NEXT_PUBLIC_GEMINI_API_KEY if it was there, assuming it's loaded from .env or system env
