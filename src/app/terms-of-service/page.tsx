      ...
      <main className="container mx-auto max-w-3xl py-8 px-4 flex-1">
        ...
        <Card className="shadow-lg">
          ...
          <CardContent className="prose prose-slate max-w-none dark:prose-invert">
            <p><em><strong>Atenção:</strong> Estes são termos de serviço modelo e não constituem aconselhamento jurídico. Adapte este conteúdo às suas necessidades específicas e consulte um profissional jurídico.</em></p>

            <h2>1. Aceitação dos Termos</h2>
            <p>Ao acessar e usar o aplicativo EMA - Electric Magnitudes Analizer ("Serviço"), você concorda em cumprir estes Termos de Serviço ("Termos"). Se você não concorda com estes Termos, não use o Serviço.</p>

            <h2>2. Descrição do Serviço</h2>
            <p>EMA - Electric Magnitudes Analizer é uma ferramenta que permite aos usuários enviar arquivos CSV contendo dados de qualidade de energia elétrica. O Serviço usa inteligência artificial (Genkit e Google AI) para analisar esses dados em relação às resoluções normativas da ANEEL e gerar relatórios de conformidade. O serviço também oferece uma interface de chat para interagir com os relatórios.</p>
            ...
            <ul>
              <li>Você é o único responsável pelo conteúdo dos arquivos CSV que envia ("Dados do Usuário") e garante que possui todos os direitos necessários para enviar e processar esses dados.</li>
            ...
            <p>O Serviço utiliza modelos de inteligência artificial (IA) para analisar seus Dados do Usuário e gerar relatórios. Embora nos esforcemos para fornecer resultados precisos, as análises e relatórios gerados por IA são fornecidos "como estão" e могут conter erros ou omissões. O Serviço não se destina a substituir o julgamento profissional de engenheiros qualificados ou aconselhamento jurídico.</p>
            <p>Os resultados gerados pela IA não devem ser considerados aconselhamento técnico ou jurídico definitivo. Você é responsável por verificar a precisão e adequação dos relatórios antes de tomar quaisquer decisões com base neles.</p>

            <h2>6. Propriedade Intelectual</h2>
            <ul>
              <li><strong>Nosso Serviço:</strong> Possuímos todos os direitos, títulos e interesses relativos ao Serviço, incluindo todo o software, design, texto, gráficos e outro conteúdo (excluindo seus Dados do Usuário e relatórios gerados a partir deles).</li>
            ...
            <p>EM NENHUMA CIRCUNSTÂNCIA O EMA - ELECTRIC MAGNITUDES ANALIZER SERÁ RESPONSÁVEL POR QUAISQUER DANOS INDIRETOS, INCIDENTAIS, ESPECIAIS, CONSEQUENCIAIS OU PUNITIVOS, INCLUINDO, SEM LIMITAÇÃO, PERDA DE LUCROS, DADOS, USO, FUNDO DE COMÉRCIO OU OUTRAS PERDAS INTANGÍVEIS, RESULTANTES DE (I) SEU ACESSO OU USO OU INCAPACIDADE DE ACESSAR OU USAR O SERVIÇO; (II) QUALQUER CONDUTA OU CONTEÚDO DE TERCEIROS NO SERVIÇO; (III) QUALQUER CONTEÚDO OBTIDO DO SERVIÇO; E (IV) ACESSO, USO OU ALTERAÇÃO NÃO AUTORIZADOS DE SUAS TRANSMISSÕES OU CONTEÚDO, SEJA COM BASE EM GARANTIA, CONTRATO, DELITO (INCLUINDO NEGLIGÊNCIA) OU QUALQUER OUTRA TEORIA JURÍDICA, TENHAMOS OU NÃO SIDO INFORMADOS DA POSSIBILIDADE DE TAIS DANOS.</p>
            ...
            <p>Estes Termos serão regidos e interpretados de acordo com as leis do Brasil, sem levar em conta suas disposições sobre conflito de leis.</p>

            <h2>12. Contato</h2>
            <p>Se você tiver alguma dúvida sobre estes Termos, entre em contato conosco por e-mail em: [Seu Endereço de E-mail de Contato].</p>
          </CardContent>
        </Card>
      </main>
